# Image Organization Script - Working Version
...
$notesDir = ".\学习笔记"
$attachmentsDir = ".\学习笔记\attachments"
...
if ($imageRefs.Count -gt 0) {
    ...
    $imageRefs.Keys | Select-Object -First 5 | ForEach-Object { Write-Host "  - $_" }
}
...
$allImages = Get-ChildItem "." -File | Where-Object { $_.Extension -match '\.(png|jpg|jpeg|gif|avif|webp)$' }
...
Write-Host "`nNote: Unused images were NOT deleted."
