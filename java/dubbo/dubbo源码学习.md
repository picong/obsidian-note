## Dubbo架构简介![[java/dubbo/attachments/Pasted image 20241024181356.png]]]
...
dubbo框架为了尽可能保障与运行，除了有failover故障转移策略，还有许多的容错策略：![[java/dubbo/attachments/Pasted image 20241204162509.png]]]
...
### Dubbo核心源码模块
- **dubbo-common模块：** Dubbo的一个公共模块，其中有很多种工具类以及公用逻辑。![[java/dubbo/attachments/Pasted image 20241024182733.png]]]
...
![[attachments/Pasted image 20241025180826.png]]
...
![[attachments/Pasted image 20241205145141.png]]
...
## Dubbo十层模块的作用![[java/dubbo/attachments/Pasted image 20241126214551.png]]]
...
## Wrapper机制
### 生成代理类的流程![[java/dubbo/attachments/Pasted image 20241127170547.png]]]
生成代理类的流程总结起来有3点：
...
![[attachments/Pasted image 20241129115505.png]]
## Provider发布流程
发布的大致流程就3个环节: **配置 -> 导出 -> 注册**。
### 配置流程![[java/dubbo/attachments/Pasted image 20241129184249.png]]]
### 导出流程
```java
...
```
- procolSPI.export![[java/dubbo/attachments/Pasted image 20241129184605.png]]]
- exportRemote远程导出![[java/dubbo/attachments/Pasted image 20241129184648.png]]]
启动netty服务：![[java/dubbo/attachments/Pasted image 20241129184748.png]]]
注册：往注册中心写入服务接口信息![[java/dubbo/attachments/Pasted image 20241129184914.png]]]
## 小结
![[attachments/Pasted image 20241129185104.png]]
