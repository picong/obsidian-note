...
![[attachments/Pasted image 20240411161036.png]]
## 线程饥饿
线程饥饿(Thread Starvation) 是指线程一直无法获得其所需的资源而导致其任务一直无法进展的一种活性故障。

## 小结
![[attachments/Pasted image 20240411165651.png]]
# 线程管理
...
![[attachments/Pasted image 20240412104440.png]]
...
## java异步编程总结：
![[attachments/Pasted image 20240415152458.png]]
## 多线程程序测试
...
## 小结
![[attachments/Pasted image 20240417184201.png]]
# Java多线程程序的性能调校
## Java虚拟机对内部锁的优化
...
![[attachments/Pasted image 20240527181503.png]]
